...
import { getPatients, getPatientsList, getPatientById, addPatient, updatePatient, deletePatient, getPatientHistory, getGlobalStats } from '../controllers/patient.controller.js';

const router = express.Router();

router.get('/patients', auth, getPatients);
router.get('/patients/list', auth, getPatientsList);
